...
// IOCompletionPortDlg.cpp : implementation file
//
...
CIOCompletionPortDlg::CIOCompletionPortDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_IOCOMPLETIONPORT_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CIOCompletionPortDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CIOCompletionPortDlg message handlers
